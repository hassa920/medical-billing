...
const SLIDES = [
  {
    ...
    sub: 'AI that listens, codes, and orders — automatically. Save 2+ hours of documentation per physician per day.',
  ...
  },
  {
    ...
    sub: 'EHR, Billing, and Patient Engagement unified in one intelligent platform. No complexity. Just care.',
  ...
  },
  {
    ...
    sub: 'Automate appointment booking, patient intake, and queries with AI — so your staff can focus on care.',
